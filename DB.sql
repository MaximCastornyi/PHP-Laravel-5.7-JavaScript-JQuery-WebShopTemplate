...
-- Dumping database structure for laravelwebshop
CREATE DATABASE IF NOT EXISTS `laravelwebshop` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `laravelwebshop`;

-- Dumping structure for table laravelwebshop.cart
...
-- Dumping data for table laravelwebshop.cart: ~7 rows (approximately)
...
INSERT INTO `cart` (`id`, `products_id`, `product_name`, `product_code`, `product_color`, `size`, `price`, `quantity`, `user_email`, `session_id`, `created_at`, `updated_at`) VALUES
	(36, 33, 'Cole Haan', 'SKU-Haan1', 'Brown', '25', 12.00, 1, 'weshare@gmail.com', 'OrHCEFHcACdGNXet3m2jVbzlJS0VybkkeknXXilx', '2020-12-06 02:18:10', '2020-12-06 02:18:10'),
	(37, 32, 'Vionic Shoes Brand', 'SKU-Vionic3', 'All Colors', '30', 20.00, 1, 'weshare@gmail.com', 'OrHCEFHcACdGNXet3m2jVbzlJS0VybkkeknXXilx', '2020-12-06 02:30:33', '2020-12-06 02:30:33'),
	(39, 31, 'House', 'SKU-House1', 'White and Brown', '5*20', 25.00, 4, 'weshare@gmail.com', 'SFoV6rkDUv7y5F81nKOo5H3u0ERK3EYkcBQhUrcm', '2020-12-06 17:49:50', '2020-12-06 17:49:50'),
	(40, 30, 'Link House New LC2', 'SKU-Link House1', 'Gray', 'Small', 10.00, 5, 'weshare@gmail.com', 'SFoV6rkDUv7y5F81nKOo5H3u0ERK3EYkcBQhUrcm', '2020-12-06 17:50:30', '2020-12-06 17:50:30'),
	(41, 31, 'House', 'SKU-House2', 'White and Brown', '10*10', 20.00, 2, 'weshare@gmail.com', 'bKnMoW6lH0eA6ciYTU47tgeayw5CFUzBkjkBb3F5', '2020-12-06 18:17:37', '2020-12-06 18:17:37'),
	(42, 34, 'Lenovo ThinkPad', 'SKU-Lenovo X1', 'Black', '15 inch', 10.00, 2, 'weshare@gmail.com', 'bKnMoW6lH0eA6ciYTU47tgeayw5CFUzBkjkBb3F5', '2020-12-06 18:18:26', '2020-12-06 18:18:26'),
	(43, 35, 'Cloths', 'SKU-Red', 'Black', 'S', 2.00, 5, 'weshare@gmail.com', 'bKnMoW6lH0eA6ciYTU47tgeayw5CFUzBkjkBb3F5', '2020-12-06 18:18:31', '2020-12-06 18:18:31');
/*!40000 ALTER TABLE `cart` ENABLE KEYS */;

-- Dumping structure for table laravelwebshop.categories
...
-- Dumping data for table laravelwebshop.categories: ~8 rows (approximately)
/*!40000 ALTER TABLE `categories` DISABLE KEYS */;
INSERT INTO `categories` (`id`, `parent_id`, `name`, `description`, `url`, `status`, `remember_token`, `created_at`, `updated_at`) VALUES
	(10, 0, 'House', 'House Category', 'http://wornnarith.cambosoft.com', 1, NULL, '2020-10-22 21:31:29', '2020-11-16 02:05:53'),
	(11, 0, 'Shoes', 'Shoes Category', 'http://wornnarith.cambosoft.com', 1, NULL, '2020-10-22 21:32:14', '2020-11-16 02:07:15'),
	(12, 0, 'Car', 'Car Category', 'http://wornnarith.cambosoft.com', 1, NULL, '2020-10-22 21:32:33', '2020-11-16 02:00:00'),
	(13, 0, 'Computer', 'Computer Category', 'http://wornnarith.cambosoft.com', 1, NULL, '2020-10-22 21:33:26', '2020-11-16 02:05:43'),
	(14, 0, 'Cloths', 'Cloths Category', 'http://wornnarith.cambosoft.com', 1, NULL, '2020-10-22 21:34:31', '2020-11-16 02:05:18'),
	(15, 12, 'Toyota', 'Toyota Sub Category of Car', 'http://wornnarith.cambosoft.com', 1, NULL, '2020-10-22 21:35:08', '2020-11-16 01:54:49'),
	(16, 10, 'Link House', 'Link House Sub Category', 'http://wornnarith.cambosoft.com', 1, NULL, '2020-10-22 21:56:56', '2020-11-16 02:07:05'),
	(17, 11, 'Man Shoes', 'Man Shoes Sub Category of Shoes', 'http://wornnarith.cambosoft.com', 1, NULL, '2020-10-22 21:58:13', '2020-11-16 01:53:44');
/*!40000 ALTER TABLE `categories` ENABLE KEYS */;

-- Dumping structure for table laravelwebshop.countries
...
-- Dumping data for table laravelwebshop.countries: ~296 rows (approximately)
...
-- Dumping structure for table laravelwebshop.coupons
...
-- Dumping data for table laravelwebshop.coupons: ~1 rows (approximately)
/*!40000 ALTER TABLE `coupons` DISABLE KEYS */;
INSERT INTO `coupons` (`id`, `coupon_code`, `amount`, `amount_type`, `expiry_date`, `status`, `created_at`, `updated_at`) VALUES
	(6, 'Coupon001', 10, 'Percentage', '2019-12-06', 1, '2020-12-05 20:19:15', '2020-12-05 20:19:15');
/*!40000 ALTER TABLE `coupons` ENABLE KEYS */;

-- Dumping structure for table laravelwebshop.delivery_address
...
-- Dumping data for table laravelwebshop.delivery_address: ~2 rows (approximately)
...
-- Dumping structure for table laravelwebshop.migrations
...
-- Dumping data for table laravelwebshop.migrations: ~12 rows (approximately)
/*!40000 ALTER TABLE `migrations` DISABLE KEYS */;
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES
	(1, '2014_10_12_000000_create_users_table', 1),
	(2, '2014_10_12_100000_create_password_resets_table', 1),
	(3, '2020_07_12_112800_create_categories_table', 1),
	(4, '2020_07_12_112833_create_products_table', 1),
	(5, '2020_07_12_112911_create_product_att_table', 1),
	(6, '2020_07_12_112939_create_tblgallery_table', 1),
	(7, '2020_07_12_113008_create_cart_table', 1),
	(8, '2020_07_12_113035_create_coupons_table', 1),
	(9, '2020_07_12_113119_create_countries_table', 1),
	(10, '2020_07_12_113153_add_more_fields_to_users_table', 1),
	(11, '2020_07_12_113228_create_delivery_address_table', 1),
	(12, '2020_07_12_113259_create_orders_table', 1);
/*!40000 ALTER TABLE `migrations` ENABLE KEYS */;

-- Dumping structure for table laravelwebshop.orders
...
-- Dumping data for table laravelwebshop.orders: ~2 rows (approximately)
...
INSERT INTO `orders` (`id`, `users_id`, `users_email`, `name`, `address`, `city`, `state`, `pincode`, `country`, `mobile`, `shipping_charges`, `coupon_code`, `coupon_amount`, `order_status`, `payment_method`, `grand_total`, `created_at`, `updated_at`) VALUES
	(6, 4, 'weshare@gmail.com', 'weshare', 'address', 'city', 'state', 'pincode', 'Cambodia', 'mobile', 0.00, 'Coupon001', '2', 'success', 'Paypal', '18', '2020-12-06 01:45:09', '2020-12-06 01:45:09'),
	(7, 1, 'demo@gmail.com', 'WeShare', '123 Street', 'Phnom Penh', 'PP', '12252', 'Cambodia', '010313234', 0.00, 'NO Coupon', '0', 'success', 'Paypal', '70', '2020-12-06 18:20:18', '2020-12-06 18:20:18');
/*!40000 ALTER TABLE `orders` ENABLE KEYS */;

-- Dumping structure for table laravelwebshop.password_resets
...
-- Dumping data for table laravelwebshop.password_resets: ~0 rows (approximately)
/*!40000 ALTER TABLE `password_resets` DISABLE KEYS */;
/*!40000 ALTER TABLE `password_resets` ENABLE KEYS */;

-- Dumping structure for table laravelwebshop.products
...
-- Dumping data for table laravelwebshop.products: ~9 rows (approximately)
/*!40000 ALTER TABLE `products` DISABLE KEYS */;
INSERT INTO `products` (`id`, `categories_id`, `p_name`, `p_code`, `p_color`, `description`, `price`, `image`, `created_at`, `updated_at`) VALUES
	(27, 15, '2019 New Toyota Highlander XLE V6', 'XLE V6 FWD', 'White', 'Sunroof, Heated Leather Seats, NAV, 3rd Row Seat, Alloy Wheels, Quad Seats, Rear Air, Power Liftgate. XLE trim. Warranty 5 yrs/60k Miles - Drivetrain Warranty; AND MORE!', 20.00, '1544063425-2019-new-toyota-highlander-xle-v6.jpg', '2020-12-05 19:30:25', '2020-12-05 19:43:57'),
	(28, 15, 'Lexus Rx 330', '12152', 'White', 'EXCELLENT SAFETY FOR YOUR FAMILY<br>Child Safety Locks, Electronic Stability Control, Brake Assist, 4-Wheel ABS, Tire Pressure Monitoring System, 4-Wheel Disc Brakes Safety equipment includes Child Safety Locks', 15.00, '1544063712-lexus-rx-330.jpg', '2020-12-05 19:35:12', '2020-12-05 19:43:48'),
	(29, 12, '2020 Toyota Prius', '1252', 'Red', 'VEHICLE FEATURES<br>Rear Spoiler, MP3 Player, Remote Trunk Release, Keyless Entry, Privacy Glass.&nbsp;', 5.00, '1544063924-2020-toyota-prius.jpg', '2020-12-05 19:38:44', '2020-12-05 19:43:38'),
	(30, 16, 'Link House New LC2', 'L_1252', 'Gray', 'Borey Peng Huoth Cambodia', 10.00, '1544064142-link-house-new-lc2.jpg', '2020-12-05 19:42:22', '2020-12-05 19:42:22'),
	(31, 10, 'House', '5214', 'White and Brown', 'House For Sale', 10.00, '1544064430-house.jpg', '2020-12-05 19:47:10', '2020-12-05 19:47:10'),
	(32, 11, 'Vionic Shoes Brand', '5265', 'All Colors', 'Women Shoes', 12.00, '1544064607-vionic-shoes-brand.jpg', '2020-12-05 19:50:07', '2020-12-05 19:50:07'),
	(33, 17, 'Cole Haan', 'KHR 775659.29', 'Brown', 'Men\'s Original Grand Wingtip Oxfords', 5.00, '1544064903-cole-haan.jpg', '2020-12-05 19:55:03', '2020-12-05 19:55:03'),
	(34, 13, 'Lenovo ThinkPad', '1252', 'Black', 'Lenovo Thinkpad From China', 2.00, '1544065331-lenovo-thinkpad.jpg', '2020-12-05 20:02:12', '2020-12-05 20:02:12'),
	(35, 14, 'Cloths', 'The Man', 'Black', 'Cloths Description here', 2.00, '1544065493-cloths.png', '2020-12-05 20:04:54', '2020-12-05 20:04:54');
/*!40000 ALTER TABLE `products` ENABLE KEYS */;

-- Dumping structure for table laravelwebshop.product_att
...
-- Dumping data for table laravelwebshop.product_att: ~24 rows (approximately)
...
INSERT INTO `product_att` (`id`, `products_id`, `sku`, `size`, `price`, `stock`, `created_at`, `updated_at`) VALUES
	(11, 35, 'SKU-Black', 'M', 5.00, 10, '2020-12-05 20:07:11', '2020-12-05 20:07:11'),
	(12, 35, 'SKU-White', 'L', 6.00, 2, '2020-12-05 20:07:42', '2020-12-05 20:07:42'),
	(13, 35, 'SKU-Red', 'S', 2.00, 5, '2020-12-05 20:08:08', '2020-12-05 20:08:08'),
	(14, 34, 'SKU-Lenovo X1', '15 inch', 10.00, 2, '2020-12-05 20:08:43', '2020-12-05 20:08:43'),
	(15, 34, 'SKU-Carbon', '14 inch', 4.00, 5, '2020-12-05 20:09:05', '2020-12-05 20:09:05'),
	(16, 33, 'SKU-Haan1', '25', 12.00, 3, '2020-12-05 20:09:45', '2020-12-05 20:09:45'),
	(17, 33, 'SKU-Haan2', '22', 10.00, 1, '2020-12-05 20:09:58', '2020-12-05 20:09:58'),
	(18, 33, 'SKU-Haan3', '19', 2.00, 3, '2020-12-05 20:10:16', '2020-12-05 20:10:16'),
	(19, 32, 'SKU-Vionic1', '20', 10.00, 5, '2020-12-05 20:11:02', '2020-12-05 20:11:02'),
	(20, 32, 'SKU-Vionic2', '20', 15.00, 4, '2020-12-05 20:11:24', '2020-12-05 20:11:24'),
	(21, 32, 'SKU-Vionic3', '30', 20.00, 1, '2020-12-05 20:11:38', '2020-12-05 20:11:38'),
	(22, 31, 'SKU-House1', '5*20', 25.00, 4, '2020-12-05 20:12:13', '2020-12-05 20:12:13'),
	(23, 31, 'SKU-House2', '10*10', 20.00, 2, '2020-12-05 20:12:30', '2020-12-05 20:12:30'),
	(24, 31, 'SKU-House3', '20*20', 20.00, 5, '2020-12-05 20:12:46', '2020-12-05 20:12:46'),
	(25, 30, 'SKU-Link House1', 'Small', 10.00, 5, '2020-12-05 20:13:06', '2020-12-05 20:13:06'),
	(26, 30, 'SKU-House2', 'Medium', 15.00, 23, '2020-12-05 20:13:23', '2020-12-05 20:13:23'),
	(27, 30, 'SKU-House3', 'Large', 5.00, 2, '2020-12-05 20:14:55', '2020-12-05 20:14:55'),
	(28, 29, 'SKU-Prius1', 'One Size', 12.00, 2, '2020-12-05 20:15:43', '2020-12-05 20:15:43'),
	(29, 28, 'SKU-Lexus Red', 'Size Red', 12.00, 12, '2020-12-05 20:16:28', '2020-12-05 20:16:28'),
	(30, 28, 'SKU-Lexus2', 'Size Black', 11.00, 22, '2020-12-05 20:16:48', '2020-12-05 20:16:48'),
	(31, 28, 'SKU-Lexus3', 'Size White', 12.00, 2, '2020-12-05 20:17:02', '2020-12-05 20:17:02'),
	(32, 27, 'SKU-Hilander', 'Size Black', 50.00, 10, '2020-12-05 20:17:35', '2020-12-05 20:17:35'),
	(33, 27, 'SKU-Hilander1', 'Size White', 20.00, 10, '2020-12-05 20:17:46', '2020-12-05 20:17:46'),
	(34, 27, 'SKU-Hilande3', 'Size Red', 20.00, 10, '2020-12-05 20:18:01', '2020-12-05 20:18:01');
/*!40000 ALTER TABLE `product_att` ENABLE KEYS */;

-- Dumping structure for table laravelwebshop.tblgallery
...
-- Dumping data for table laravelwebshop.tblgallery: ~27 rows (approximately)
/*!40000 ALTER TABLE `tblgallery` DISABLE KEYS */;
INSERT INTO `tblgallery` (`id`, `products_id`, `image`, `created_at`, `updated_at`) VALUES
	(8, 27, '7664271544063472.jpg', '2020-12-05 19:31:12', '2020-12-05 19:31:12'),
	(9, 27, '6768551544063472.jpg', '2020-12-05 19:31:13', '2020-12-05 19:31:13'),
	(10, 27, '4131281544063473.jpg', '2020-12-05 19:31:13', '2020-12-05 19:31:13'),
	(11, 28, '6720891544063734.jpg', '2020-12-05 19:35:34', '2020-12-05 19:35:34'),
	(12, 28, '4686631544063734.jpg', '2020-12-05 19:35:34', '2020-12-05 19:35:34'),
	(13, 28, '5960611544063759.jpeg', '2020-12-05 19:35:59', '2020-12-05 19:35:59'),
	...
	(20, 31, '9233341544064441.jpg', '2020-12-05 19:47:21', '2020-12-05 19:47:21'),
	...
	(23, 32, '3998691544064618.jpg', '2020-12-05 19:50:18', '2020-12-05 19:50:18'),
	(24, 32, '1159141544064618.jpg', '2020-12-05 19:50:18', '2020-12-05 19:50:18'),
	(25, 32, '2035101544064618.jpg', '2020-12-05 19:50:18', '2020-12-05 19:50:18'),
	(26, 33, '2128501544064917.jpg', '2020-12-05 19:55:17', '2020-12-05 19:55:17'),
	(27, 33, '5649911544064917.jpg', '2020-12-05 19:55:17', '2020-12-05 19:55:17'),
	(28, 33, '3704141544064917.jpg', '2020-12-05 19:55:17', '2020-12-05 19:55:17'),
	(29, 34, '3899431544065346.JPG', '2020-12-05 20:02:26', '2020-12-05 20:02:26'),
	(30, 34, '119131544065346.jpg', '2020-12-05 20:02:27', '2020-12-05 20:02:27'),
	(31, 34, '6905491544065347.jpg', '2020-12-05 20:02:27', '2020-12-05 20:02:27'),
	(32, 35, '981591544065510.jpeg', '2020-12-05 20:05:10', '2020-12-05 20:05:10'),
	(33, 35, '5320811544065510.jpg', '2020-12-05 20:05:11', '2020-12-05 20:05:11'),
	(34, 35, '1153181544065511.jpg', '2020-12-05 20:05:11', '2020-12-05 20:05:11');
/*!40000 ALTER TABLE `tblgallery` ENABLE KEYS */;

-- Dumping structure for table laravelwebshop.users
...
-- Dumping data for table laravelwebshop.users: 1 rows
...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `admin`, `remember_token`, `created_at`, `updated_at`, `address`, `city`, `state`, `country`, `pincode`, `mobile`) VALUES
	(6, 'Max', 'max@max.com', '2020-07-12 16:20:47', '$2y$10$6sIR67Ct/5.8ng5KWi4rp.oGeDze3SocUZpda/FOHaifpxuFbAPwS', 1, NULL, '2020-07-12 13:12:25', '2020-07-12 13:12:25', NULL, NULL, NULL, NULL, NULL, NULL);
